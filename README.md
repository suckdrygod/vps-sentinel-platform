...
| 子系统 | 仓库 | 锁定版本 | 锁定提交 |
| --- | --- | --- | --- |
| Komari Panel | [suckdrygod/komari](https://github.com/suckdrygod/komari) | `1.2.5-tg.25` | `267e20922192afec4586886378df8661f2b9ec78` |
...
| Komari Web | [suckdrygod/komari-web](https://github.com/suckdrygod/komari-web) | `radix` snapshot | `ea27b292360d0c0cc61c0ad66765a761e3d604cb` |

> 禁止使用 `latest` 作为生产部署依据。所有组件都通过 tag/commit 固定。
